...
QT_MOC_LITERAL(1, 9, 15), // "FinishedSetting"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Settings\0FinishedSetting\0"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->FinishedSetting(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Settings::FinishedSetting)) {
                *result = 0;
                return;
            }
        }
