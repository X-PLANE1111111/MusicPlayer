...
QT_MOC_LITERAL(1, 13, 14), // "NeedToAddMusic"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "DeleteMusic"
QT_MOC_LITERAL(4, 41, 5), // "index"
QT_MOC_LITERAL(5, 47, 9) // "EditMusic"

    },
    "MyListWidget\0NeedToAddMusic\0\0DeleteMusic\0"
    "index\0EditMusic"
};
...
void MyListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NeedToAddMusic(); break;
        case 1: _t->DeleteMusic((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->EditMusic((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyListWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListWidget::NeedToAddMusic)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyListWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListWidget::DeleteMusic)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyListWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListWidget::EditMusic)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject MyListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_MyListWidget.data,
      qt_meta_data_MyListWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MyListWidget::NeedToAddMusic()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyListWidget::DeleteMusic(int _t1)
{
...
// SIGNAL 2
void MyListWidget::EditMusic(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
